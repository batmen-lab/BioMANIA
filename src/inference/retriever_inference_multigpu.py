...
import pandas as pd
import torch
from transformers import BertModel, BertTokenizer, pipeline, BertConfig
...
class ToolRetriever:
    def __init__(self, LIB, corpus_tsv_path="", model_path="bert-base-uncased"):
        ...
        self.shuffled_query_embeddings = self.encode_queries(self.shuffled_queries)
    ...
    def build_retrieval_corpus(self, corpus_tsv_path):
        ...
        self.corpus_embeddings = self.encode_corpus(corpus)
    ...
    def encode_queries(self, queries):
        ...
        return torch.tensor(query_embeddings)
...
def compute_accuracy(retriever, data, args, name='train'):
    ...
    for query_data in tqdm(data):
        ...
        query_embedding = retriever.encode_queries([query_data['query']])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--retrieval_model_path', type=str, default='bert-base-uncased', help='')
