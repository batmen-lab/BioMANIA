...
class LLaMA(nn.Module):
    def __init__(self, config: LLaMAConfig, return_after_wte: bool = False) -> None:
        super().__init__()
        assert config.padded_vocab_size is not None
        self.config = config
        self.return_after_wte = return_after_wte
    ...
    def forward(
        ...
        # If the hook flag is set, return immediately after wte
        if self.return_after_wte:
            return x
