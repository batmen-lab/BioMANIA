...
API_HTML, API_HTML_PATH, GITHUB_LINK, READTHEDOC_LINK, LIB_ALIAS, TUTORIAL_HTML_PATH, TUTORIAL_GITHUB, LIB_ANALYSIS_PATH, LIB_GITHUB_PATH = [info_json[key] for key in ['API_HTML', 'API_HTML_PATH', 'GITHUB_LINK', 'READTHEDOC_LINK', 'LIB_ALIAS', 'TUTORIAL_HTML_PATH', 'TUTORIAL_GITHUB', 'LIB_ANALYSIS_PATH', 'LIB_GITHUB_PATH']]
